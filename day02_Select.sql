...
/*--Q1: Derecesi 90 dan yuksek olan ogrencilerin tum bilgilerini getir.*/
Select *
from meslek_lisesi
where derece>90;
/*--Q1: Derecesi 80 dan yuksek olan ogrencilerin isimlerini getir.*/
Select isim
from meslek_lisesi
where derece<80;
...
from meslek_lisesi
where okul_no='1005';
-- Q5: derecesi 70 80 arasinda olan ogrencilerin okul_no ve adres bilgisisni getiriniz.
...
-- bize isimleri alfabedeki siralamaya gore veriyor.

Select isim
from ogretmen_lisesi
where isim
between 'Muhammet Talha' and 'Tugba';
...
-- siralamayi kayit sirasina gore yapiyor
/*-------------------------------------------------------------------------
